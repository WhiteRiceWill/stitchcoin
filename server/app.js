...
if (productionMode) {
  ...
  // For when SIGINT isn't recieved listen for shutdown event and give a little time to finish and close all connections
...
//Parse json automatically based on header
...
// 404 Error handler for anything else
